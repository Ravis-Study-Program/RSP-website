...
The two dirty TypeScript files are retained under `docs/legacy-snapshot/` as
semantic evidence. Branding and favicon files were copied to `apps/web/public`.
The legacy `.git`, C# source, secrets, dependency/build directories, and Railway
configuration were not imported.
